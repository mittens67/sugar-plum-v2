...
import { permanentlyDeleteProduct } from "../actions";
...
export default function HardDeleteButton({ productId, itemName }: HardDeleteButtonProps) {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await permanentlyDeleteProduct(BigInt(productId));
      setIsOpen(false);
    } catch (error) {
  ...
  const modalContent = isOpen && (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* High Visibility Modal - Solid Pure White */}
        ...
        <div className="overflow-y-auto flex-1 custom-scrollbar">
            <CardHeader className="text-center pt-10 px-8 pb-4">
              ...
              <div className="space-y-1">
                <p className="text-[10px] text-plum/50 font-black uppercase tracking-[0.2em]">Item to be purged:</p>
            ...
            <CardContent className="space-y-6 p-8 pt-0">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 pt-2">
                  ...
                  >
                    {isDeleting ? "PURGING DATA..." : "CONFIRM HARD DELETE"}
                  </Button>
                  <button
              ...
              <p className="text-[10px] text-center text-red-500 font-bold opacity-60">
