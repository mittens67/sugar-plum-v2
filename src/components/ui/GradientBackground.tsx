...
export default function GradientBackground({ className = "" }: GradientBackgroundProps) {
  return (
    <div className={`absolute inset-0 -z-10 overflow-hidden bg-background ${className}`}>
      ...
      <div className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] rounded-full bg-plum/5 blur-[120px] animate-pulse" />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-linear-to-tr from-white/20 via-transparent to-white/10 pointer-events-none" />
